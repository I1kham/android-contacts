...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<ContactUi> differ = new AsyncListDiffer<>(
            ...
            new AsyncDifferConfig.Builder<>(new <ContactUi> BaseListDiffCallback()).build()//todo
    );
...
//    static class ListDiffCallback extends DiffUtil.ItemCallback<ContactUi> {//todo to delete?
//
//        @Override
